  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-background/95">
      ...
      <div className="relative container mx-auto px-4 py-12">
        <header className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-5xl font-bold glow-text bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
              The Sensor Whisperer
            </h1>
            <Cpu className="w-10 h-10 text-secondary glow-text animate-pulse" />
          </div>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Decode the mysteries of IoT devices with AI-powered intelligence
          </p>
        </header>
      ...
      <footer className="relative mt-20 text-center text-muted-foreground text-sm pb-8">
        <p>Powered by AI • Secure • Real-time Analysis</p>
      </footer>
    </div>
  );
};
